...
export const generateTablePackageDefinition = {
    ...
    description: "Generates a complete SIGA-compliant Oracle PL/SQL package (spec .pks + body .pkb) for a given table. " +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            moduleName: {
                type: "string",
                description: "Module abbreviation prefix (e.g. 'AED', 'EFD', 'COR'). Used to name the package: PK_[MODULE]_[SHORTNAME]. If omitted, module is inferred or left blank.",
            },
            shortName: {
                type: "string",
                description: "Optional custom short name for the table (e.g. 'BEMIMOBEFD'). If omitted, it will be auto-derived from the table name.",
            },
            author: {
                type: "string",
