...
export const getTableIndexesDefinition = {
    ...
    description: "Obtém todos os índices de uma tabela específica, incluindo nome do índice, tipo, unicidade, colunas e status. " +
    ...
    inputSchema: {
        ...
        properties: {
            tableName: {
                type: "string",
                description: "O nome da tabela para recuperar os índices (case-insensitive).",
            },
            includeStats: {
                type: "boolean",
                description: "Se verdadeiro, inclui estatísticas adicionais como chaves distintas, blocos de folhas e data da última análise. Padrão: false.",
            },
